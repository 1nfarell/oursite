...
function check_str_occurrence (search_str){    
    ...
    let soft_okna="мягкие окна окно установка монтаж ремонт для террас и веранд кафе беседка беседок веранды террасы пленка гибкие оксфорд ткань окантовка французкий замок люверсы круглые поворотная скоба"
    ...
    let vse_dveri = "двери дверь пластиковые установка монтаж покраска автоматические механические козырьки раздвижные ремонт прозрачные рольставни на"
